...
//        ambil data prodi dari database
        String query_prodi = "SELECT kdprodi,nmprodi FROM PETERNAKAN ORDER BY kdprodi";
...
//        jika di klik salah satu prodi tampilkan activity detail prodi
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View container,
                ...
                if (position == 0) {
                    Intent myIntent = new Intent(container.getContext(), ProTer.class);
                ...
                if (position == 3) {
                    Intent myIntent = new Intent(container.getContext(), TekProTer.class);
                    startActivityForResult(myIntent, 0);
                }
                if (position == 4) {
                    Intent myIntent = new Intent(container.getContext(), TekPembenihanIkan.class);
                    startActivityForResult(myIntent, 0);
                }
            }
        };
